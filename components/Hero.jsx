      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          <motion.div variants={child}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 border border-slate-700 text-sm text-gradient mb-6">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
              Available for Mid Level Frontend Roles
            </div>
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-serif font-bold tracking-tight text-gradient mb-6">
              Md. Nazmul Hasan
            </h1>
            <h3 className="sm:text-2xl text-slate-400 font-light mb-7">
              <TypeWriter />
            </h3>
